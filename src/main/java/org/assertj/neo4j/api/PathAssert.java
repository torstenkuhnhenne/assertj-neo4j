 ...
 */
public class PathAssert extends IterableAssert<Entity> {

    protected PathAssert( final Path actual ) {
        super( actual );
    }
     ...
     */
    public PathAssert startsWithNode( final Node node ) {
        Objects.instance().assertNotNull( this.info, this.actual );

        final Path actualPath = getActual();
        final Node actualStart = actualPath.startNode();
        checkNullStartNodes( actualStart, node );

        if ( !actualStart.equals( node ) ) {
            throw Failures.instance().failure( this.info, shouldStartWithNode( actualPath, node ) );
        }
        return this;
    }
     ...
     */
    public PathAssert doesNotStartWithNode( final Node node ) {
        Objects.instance().assertNotNull( this.info, this.actual );
        ...
        checkNullStartNodes( actualStart, node );
        if ( actualStart.equals( node ) ) {
            throw Failures.instance().failure( this.info, shouldNotStartWithNode( actualPath, node ) );
        }
        return this;
    }
     ...
     */
    public PathAssert endsWithNode( final Node node ) {
        Objects.instance().assertNotNull( this.info, this.actual );

        final Path actualPath = getActual();
        final Node actualEnd = actualPath.endNode();
        checkNullEndNodes( actualEnd, node );

        if ( !actualEnd.equals( node ) ) {
            throw Failures.instance().failure( this.info, shouldEndWithNode( actualPath, node ) );
        }
        return this;
    }
     ...
     */
    public PathAssert doesNotEndWithNode( final Node node ) {
        Objects.instance().assertNotNull( this.info, this.actual );
        ...
        if ( actualEnd.equals( node ) ) {
            throw Failures.instance().failure( this.info, shouldNotEndWithNode( actualPath, node ) );
        }
        return this;
    }
     ...
     */
    public PathAssert endsWithRelationship( final Relationship relationship ) {
        Objects.instance().assertNotNull( this.info, this.actual );

        final Path actualPath = getActual();
        final Relationship actualLastRelationship = actualPath.lastRelationship();
        checkNullEndRelationships( actualLastRelationship, relationship );

        if ( !actualLastRelationship.equals( relationship ) ) {
            throw Failures.instance().failure( this.info, shouldEndWithRelationship( actualPath, relationship ) );
        }
        return this;
    }
     ...
     */
    public PathAssert doesNotEndWithRelationship( final Relationship relationship ) {
        Objects.instance().assertNotNull( this.info, this.actual );
        ...
        if ( actualLastRelationship.equals( relationship ) ) {
            throw Failures.instance().failure( this.info, shouldNotEndWithRelationship( actualPath, relationship ) );
        }
        return this;
    }
     ...
     */
    public PathAssert hasLength( final int length ) {
        Objects.instance().assertNotNull( this.info, this.actual );
        ...
        if ( actualPath.length() != length ) {
            throw Failures.instance().failure( this.info, ShouldHaveLength.shouldHaveLength( actualPath, length ) );
        }
        return this;
    }

    private static void checkNullStartNodes( final Node actualStart, final Node expectedStart ) {
        if ( actualStart == null ) {
    ...
    private static void checkNullEndNodes( final Node actualEnd, final Node expectedEnd ) {
        if ( actualEnd == null ) {
    ...
    private static void checkNullEndRelationships( final Relationship actualEnd, final Relationship expectedEnd ) {
        if ( actualEnd == null ) {
